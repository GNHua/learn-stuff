...
class HTexture:
    ...
    def render(self, x, y, degrees, clip = None, stretch = None):
        if self.mTextureID != 0:
            glLoadIdentity()
            texTop = 0.
            ...
            glBegin(GL_QUADS)
            glTexCoord2f(  texLeft,    texTop ); glVertex2f( -quadWidth/2, -quadHeight/2 );
            glTexCoord2f( texRight,    texTop ); glVertex2f(  quadWidth/2, -quadHeight/2 );
            glTexCoord2f( texRight, texBottom ); glVertex2f(  quadWidth/2,  quadHeight/2 );
            glTexCoord2f(  texLeft, texBottom ); glVertex2f( -quadWidth/2,  quadHeight/2 );
            glEnd()