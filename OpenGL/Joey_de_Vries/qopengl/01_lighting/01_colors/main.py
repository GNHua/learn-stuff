...
class Window(QtGui.QOpenGLWindow):
    ...
    def initializeGL(self):
        ...
        self.lightingShaderProg.addShaderFromSourceFile(
            QtGui.QOpenGLShader.Vertex, '1.colors.vert')
        self.lightingShaderProg.addShaderFromSourceFile(
            QtGui.QOpenGLShader.Fragment, '1.colors.frag')
        ...
        self.lampShaderProg.addShaderFromSourceFile(
            QtGui.QOpenGLShader.Vertex, '1.lamp.vert')
        self.lampShaderProg.addShaderFromSourceFile(
            QtGui.QOpenGLShader.Fragment, '1.lamp.frag')
