...
class Window(QtGui.QOpenGLWindow):
    ...
    def initializeGL(self):
        ...
        self.lightingShaderProg.addShaderFromSourceFile(
            QtGui.QOpenGLShader.Vertex, '2.0.colors.vert')
        self.lightingShaderProg.addShaderFromSourceFile(
            QtGui.QOpenGLShader.Fragment, '2.0.colors.frag')
        ...
        self.lampShaderProg.addShaderFromSourceFile(
            QtGui.QOpenGLShader.Vertex, '2.0.lamp.vert')
        self.lampShaderProg.addShaderFromSourceFile(
            QtGui.QOpenGLShader.Fragment, '2.0.lamp.frag')
