...
class HTexture:
    ...
    def render(self, x, y):
        if self.mTextureID != 0:
            ...
            glTexCoord2f( 1.5, 0. ); glVertex2f( self.mTextureWidth,                  0. );
            glTexCoord2f( 1.5, 1.5); glVertex2f( self.mTextureWidth, self.mTextureHeight );
            glTexCoord2f( 0., 1.5 ); glVertex2f(                 0., self.mTextureHeight );
            glEnd()
